    ...
    content:
      ...
      items:
        - title: Visiting Student in KAUST (IVUL, Advisor PhD Guohao Li, Prof. Bernard Ghanem)
          ...
          date_end: '2024-01-30'
          description: Working on the [Camel](链接地址) project, probing agent trust behavior. The paper titled "Can Large Language Models Simulate Human Trust Behaviors?" has been produced.
